...
//
// ROS-free port of the LeNet armor number classifier (from
// hfut_rm_auto_aim_ws/src/rm_auto_aim/armor_detector).

#ifndef ARMOR_DETECTOR_TRADITIONAL_NUMBER_CLASSIFIER_HPP_
#define ARMOR_DETECTOR_TRADITIONAL_NUMBER_CLASSIFIER_HPP_
...
// Classifies the armor number with the small LeNet ONNX model (OpenCV DNN).
class NumberClassifier {
 public:
  ...
  // Extract the roi image of number from the src (BGR8).
...
#endif  // ARMOR_DETECTOR_TRADITIONAL_NUMBER_CLASSIFIER_HPP_
